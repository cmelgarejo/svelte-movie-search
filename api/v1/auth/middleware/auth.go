...
// 	// w.
// 	// r. c.AbortWithStatusJSON(http.StatusUnauthorized, e)
// }

// // Middleware wraps the request with auth middleware
// func Middleware(w *http.ResponseWriter, cfg *utils.ServerConfig) *http.Handler {
// 	// logger.Info("[Auth.Middleware] Applied to path: ", path)
// 	return gin.HandlerFunc(func(r *http.Response) {
